...
const ProductsDetails = () => {
    ...
    const [tabsData , setTabsData] = useState("p")
        ...
        <div className="productsdetail_container">
            ...
            <div className="topbar_container">
                <div className="tabs_box">
                    <div className="tab" style={tabsData == "p" ? {color:"#274C7E" , borderBottom:"2px solid #274C7E"} : null} onClick={()=> setTabsData("p")}>
                        Top Products
                    </div>
                    <div className="tab" style={tabsData == "m" ? {color:"#274C7E" , borderBottom:"2px solid #274C7E"} : null} onClick={()=> setTabsData("m")}>
                        Top Machines
                    </div>
                    <div className="tab" style={tabsData == "l" ? {color:"#274C7E" , borderBottom:"2px solid #274C7E"} : null} onClick={()=> setTabsData("l")}>
                        Locations Analytics
                    </div>
                </div>
